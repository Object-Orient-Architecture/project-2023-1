...
class BuildingElement(Element):
    ...
    def build_to_rhino(self):
        ...
        for window in self.windows : Element.doc_rh.Objects.AddExtrusion(window,BuildingElement.building_attribute)
        self.extrusion_id = Element.doc_rh.Objects.AddExtrusion(extrusion,BuildingElement.building_attribute)
