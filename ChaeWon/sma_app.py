...
class SMA:
    ...
    #1 -3 | Get Result
    def get_result(self):
        rhino_exe_path = r'C:\Program Files\Rhino 7\System\Rhino.exe'
        file_to_open = path.abspath('.\\ChaeWon\\result\\result.3dm')

        call_script = '"{0}" /nosplash /runscript="_OneView _Enter _SelAll _Zoom S", "{1}"'.format(rhino_exe_path,file_to_open)
